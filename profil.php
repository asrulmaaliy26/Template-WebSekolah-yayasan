...
<body>
    ...
    <section>
        <img style="width: 100%; margin-top: 60px;" src="assets/img/header/profil.png" alt="">
    </section>
    ...
    <section>
      <div class="container-fluid pt-5 pb-5 profil">
        <div class="container pt-5 pb-5">
          <div class="row">
            <div style="width: 50%;" class="container text-center"><img style="width: 40%;" src="assets/img/logo_ts 1.png" alt=""></div>
            <h3 style="font-weight: 500; font-size: 36px;" class="pt-5 text-center">Always The Best</h3>
            <h4 class="pt-3 pb-4 text-center">Sekolah Telematika Terbaik se-Indonesia</h4>
            <div style="width: 100%;" class="container">
            <img style="width: 100%;" src="assets/img/tefa.jpg" alt=""></div>
